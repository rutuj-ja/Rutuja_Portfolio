...
function App() {
  ...
  const projects = [
...

    {
      ...
      tools: ["SQL Server", "Advanced SQL", "CTEs", "Window Functions"],
      github:
...

    {
      ...
      tools: ["SQL Server", "Database Design", "Joins", "Triggers"],
      github:
...

    {
      ...
      tools: ["SQL Server", "SQL", "Joins", "Aggregations"],
      github:
    ...
    <div className="portfolio">
        ...
        <div className="hero-container">
          ...
          <div className="hero-content">
            ...
            <p className="hero-text">
              B.Sc. Computer Science graduate specializing in Data Analytics,
              with practical experience in SQL, Excel, Power BI, Power Query,
              DAX, and Python.
            </p>
      ...
      <section id="about" className="section about-section">
        <div className="section-container">
          ...
          <div className="section-heading">
            ...
            <h2>Turning Data Into <span>Insights</span></h2>
          </div>
          ...
          <div className="about-grid">
            ...
            <div className="about-text">
              ...
              <p>
                I am a B.Sc. Computer Science graduate and an entry-level
                Data Analyst with practical experience in data cleaning,
                data analysis, data validation, reporting, KPI tracking,
                dashboard development, and data visualization.
              </p>

              <p>
                I work with <strong>SQL, Microsoft Excel, Power BI,
                  Power Query, DAX, and Python</strong> to transform raw data
                into meaningful insights. I enjoy identifying trends and
                patterns, building interactive dashboards, and presenting
                data in a clear and actionable way.
              </p>

              <p>
                I have worked on SQL and Power BI projects involving
                business analysis, HR analytics, sales analytics, database
                management, KPI reporting, and interactive visualization.
              </p>
            ...
            <div className="about-highlights">
              ...
              <div className="highlight-card">
                ...
                <div>
                  <h3>Data Analysis</h3>
                  <p>Finding trends, patterns and meaningful insights.</p>
                </div>
              </div>
              ...
              <div className="highlight-card">
                ...
                <div>
                  ...
                  <p>Creating interactive KPI dashboards and reports.</p>
                </div>
              </div>
              ...
              <div className="highlight-card">
                ...
                <div>
                  ...
                  <p>Transforming raw data into clear business reports.</p>
                </div>
              </div>
        ...
        <div className="section-container">
          ...
          <div className="section-heading center">
            ...
            <p className="section-description">
              Tools and technologies I use to analyze, transform and
              visualize data.
            </p>
          </div>
      ...
      <section id="projects" className="section projects-section">
        <div className="section-container">
          ...
          <div className="section-heading">
            ...
            <p className="section-description">
              Practical data analytics projects built using SQL, Power BI,
              Excel and database technologies.
            </p>
          </div>
                ...
                <div className="project-image">
                  ...
                  {project.image ? (
                    ...
                    <div className="project-placeholder">
                      ...
                      <strong>
                        {project.title === "COVID-19 Global Analytics Dashboard"
                          ? "COVID-19 ANALYTICS"
                          : project.title === "Sales Analytics SQL Project"
                            ? "SALES ANALYTICS"
                            : "DATA ANALYTICS"}
                      </strong>
                    </div>
        ...
        <div className="section-container">
          ...
          <div className="contact-box">
            ...
            <div className="contact-content">
              ...
              <p>
                I am currently looking for entry-level Data Analyst
                opportunities where I can apply my analytical skills,
                work with real-world data, and continue learning.
              </p>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <p>
            © {new Date().getFullYear()} Rutuja Kusalkar. All rights reserved.
          </p>
